...
<head>
    <meta charset="utf-8">
    <title>Rising Stars Agency Portal</title>
    ...
    <div class="container-xxl bg-white p-0">
        ...
        <nav class="navbar navbar-expand-lg bg-white navbar-light shadow sticky-top p-0">
            <a href="index.php" class="navbar-brand d-flex align-items-center text-center py-0 px-4 px-lg-5">
                <h1 class="m-0 text-primary">Rising Stars Agency Portal</h1>
            </a>
            ...
            <div class="collapse navbar-collapse" id="navbarCollapse">
                <div class="navbar-nav ms-auto p-4 p-lg-0">
                    ...
                    <a href="job-list.php" class="nav-item nav-link">Apply Jobs</a>
                    <!-- <a href="job-detail.php" class="nav-item nav-link">Job Detail</a> -->
                    ...
                    <a href="index.php" class="nav-item nav-link">User Login</a>
                </div>
